    ...
    <>
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12 text-gray-900 dark:text-gray-100">
        ...
        <section className="mb-6">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-lg sm:text-xl font-bold flex items-center gap-2">
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-md bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-800">
          ...
          {!changelog && !error && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {Array.from({ length: 3 }).map((_, i) => (
                <div
                  key={i}
                  className="rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 animate-pulse h-28"
                />
              ))}
            </div>
          )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {changelog.map((item, i) => (
                <motion.article
                  ...
                  className="rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm transition-colors"
                >
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-3 rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm transition-colors">
            <div className="flex items-center justify-between mb-3">
            ...
            {!roadmap && !error && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div
                    key={i}
                    className="rounded-md border border-gray-200 dark:border-gray-800 bg-gray-50/70 dark:bg-gray-950/40 p-3"
                  >
                ...
                {STAGES.map((stage) => {
                  ...
                  return (
                    <section
                      ...
                      className="rounded-md border border-gray-200 dark:border-gray-800 bg-gray-50/70 dark:bg-gray-950/40 p-3 transition-colors"
                    >
                      ...
                      <ul className="space-y-2">
                        {items.map((r) => (
                          <li key={r.id}>
                            <div className="group block rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-3 hover:bg-gray-50 dark:hover:bg-gray-800/60 hover:border-gray-300 dark:hover:border-gray-700 transition-colors">
                              <div className="flex items-start gap-3">
                                <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-gray-100 dark:bg-gray-800">
