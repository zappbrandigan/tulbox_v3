...
const SearchReplace: React.FC<SearchReplaceProps> = ({
  ...
  const commonReplacements = [
    {
      name: 'Cue Sheet Template',
      search: '.*',
      replace: 'CUE_SHEET_TEMPLATE',
      regex: true,
    },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {commonReplacements.map((template, index) => (
              <button
                ...
                className="text-left p-2 text-sm bg-white dark:bg-gray-800 rounded border border-blue-200 dark:border-blue-700 hover:border-blue-300 dark:hover:border-blue-400 transition-colors"
              >
