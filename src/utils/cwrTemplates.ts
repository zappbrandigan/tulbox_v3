...
export const CWR_TEMPLATES: CWRTemplate[] = [
  {
    ...
    description: 'View the original CWR .v21/.v22 file content, hover cells for additional info.',
    fields: []
  },
  {
    id: 'works-report',
    ...
    fields: [
      ...
      { key: 'publisherSeqNum', label: 'Pub. Seq. #', type: 'string', width: 7 },
      ...
      { key: 'contribution', label: 'Contribution', type: 'number', width: 11, style: {numFmt: '0.00'} },
      { key: 'prOwnership', label: 'PR Ownership', type: 'number', width: 10, style: {numFmt: '0.00'} },
      { key: 'mrOwnership', label: 'MR Ownership', type: 'number', width: 10, style: {numFmt: '0.00'} },
      { key: 'prCollection', label: "PR Collection", type: 'number', width: 10, style: {numFmt: '0.00'} },
      { key: 'mrCollection', label: 'MR Collection', type: 'number', width: 10, style: {numFmt: '0.00'} },
